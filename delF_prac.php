                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="Admin.php">Allotment</a></li>
                            <li class="active">Delete Alloted Practical</li>
...
<form action="deletePrac.php" method="POST" onsubmit="alert('Thanks for Subscribing');>
                                            <div class="col-lg-6">
                                                <div class="card">
