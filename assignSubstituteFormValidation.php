...
$query = mysqli_query(mysqli_connect("localhost", "root", "", "timetable"), "SELECT * FROM user_teacher WHERE faculty_number = '$whose'");
$row = mysqli_fetch_assoc($query);
$whose_name = $row['name'];
$query = mysqli_query(mysqli_connect("localhost", "root", "", "timetable"), "SELECT * FROM user_teacher WHERE faculty_number = '$sub'");
$row = mysqli_fetch_assoc($query);
$sub_name = $row['name'];
$whose = strtolower($whose);
$sub = strtolower($sub);
$query = mysqli_query(mysqli_connect("localhost", "root", "", "timetable"), "SELECT * FROM $sub WHERE day = '$day'");
$row = mysqli_fetch_assoc($query);
