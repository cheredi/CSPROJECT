    ...
    <div class="content mt-3">
        <div class="animated fadeIn">
            <div class="tab">
                ...
                <button class="tablinks" onclick="openCity(event, 'Paris')">Change Student Name</button>
                <button class="tablinks" onclick="openCity(event, 'Tokyo')">Change Class ID</button>
                <button class="tablinks" onclick="openCity(event, 'Nairobi')">Change Admission Number</button>
            ...
            <div id="Paris" class="tabcontent">
                <form action="sign2.php" class="container" method="post">
                    <h1 id="p01">  Student Name </h1>
            ...
            <div id="Tokyo" class="tabcontent">
                <form action="sign3.php" class="container" method="post">
            ...
            <div id="Nairobi" class="tabcontent">
                <form action="sign4.php" class="container" method="post">
                    <h1 > Change Admission Number </h1>
                    <label for="Email"><b>Email Address</b></label>
                    <input type="text" placeholder="Enter Email Address" name="Email" required>
                    <label for="studentid"><b> New Admission Number</b></label>
                    <input type="text" maxlength="7 " placeholder="Admission Number" name="studentid" required>
                    <button type="submit" onclick="myFunction2()" class="btn">Submit</button>
                </form>
            </div>

            <div id="Mombasa" class="tabcontent">
                <form action="sign5.php" class="container" method="post">
            ...
            <script>
                function myFunction2() {
                    var txt;
                    if (confirm("Are you sure you want to edit the above student?")) {
                        txt = "You pressed OK!";
                    } else {
