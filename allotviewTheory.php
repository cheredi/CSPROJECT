            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li class="active">View Alloted Theory</li>
...
$t = mysqli_query(mysqli_connect("localhost", "root", "", "timetable"),
    "SELECT username FROM user_teacher WHERE faculty_number = '$teacher_id'");
