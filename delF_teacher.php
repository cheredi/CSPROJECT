                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Delete Teacher</li>
...
<form action="del_teacher.php" method="POST" onsubmit="alert('Thanks for Subscribing');>
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="facultyNumber" id="facultyNumber" name="facultyNumber" placeholder="Faculty Number" class="form-control" required="true"><small class="help-block form-text"></small></div>
                                                            </div>
     ...
     <strong>Warning!</strong> Record was not deleted. Please confirm that both Email and Teacher ID are correct
  </div>
                                <!-- Right Panel -->
...
function myFunction() {
  var txt;
  if (confirm("Are you sure you want to delete the above teacher?")) {
    txt = "You pressed OK!";
  } else {
