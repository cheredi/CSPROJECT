...
<head>
    ...
    <title>Admin - Subject signUp</title>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                                            <form action="http://localhost/timetable/is/subjectAdd.php" method="POST">
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="subjectName-input" class=" form-control-label">Subject Name</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="SN" name="SN" placeholder="Subject's Name" class="form-control" required="true"><small class="help-block form-text"></small></div>
                                                            </div>
                                                        
                                                       
															          
															<div class="row form-group">
                                                                <div class="col col-md-3"><label for="subjectCode-input" class=" form-control-label">Subject Code</label></div>
                                                                <div class="col-12 col-md-9"><input type="SC" id="SC" name="SC" placeholder="CO203 C0204....." class="form-control" required="true"><small class="help-block form-text"></small></div>
                                                            </div>
...
function myFunction2() {
  var txt;
  if (confirm("Are you sure you want to add the above subject?")) {
    txt = "You pressed OK!";
  } else {
