                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Delete Classroom</li>
                            <li><a href="admin_logout.phpt">Logout </a></li>
                        </ol>
                    </div>
                </div>
            </div>
...
<form action="delClassroom.php" method="POST" onsubmit="alert('Thanks for Subscribing');>
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="name" id="name" name="name" placeholder="Enter Name" class="form-control" required="true"><small class="help-block form-text"></small></div>
                                                            </div>
     ...
     <strong>Warning!</strong> Record was not deleted. Please confirm that the name is Correct
  </div>
                                <!-- Right Panel -->
...
function myFunction() {
  var txt;
  if (confirm("Are you sure you want to delete the above Classroom?")) {
    txt = "You pressed OK!";
  } else {
