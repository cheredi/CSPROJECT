...
$q = mysqli_query(mysqli_connect("localhost", "root", "", "timetable"), "UPDATE subjects SET isAlloted=1, allotedto='$teacher' , allotedto2='$teacher2' ,
 allotedto3 ='$teacher3' WHERE subject_code='$subject'");

if ($q) {
    $message = "Done.\\nTry again.";
    echo "<script type='text/javascript'>alert('$message');</script>";
    header("Location:allotviewPrac.php");
} else {
