...
<head>
    ...
    <title>Admin - Student signUp</title>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="Admin.php">Students</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                                            <form action="http://localhost/timetable/is/StudentAdd.php" method="POST">
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="Email" id="Email" name="Email" placeholder="Enter Email" class="form-control" required="true"><small class="help-block form-text"></small></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="password-input" class=" form-control-label">Password</label></div>
                                                                <div class="col-12 col-md-9"><input type="Password" id="Password" name="Password" placeholder="Password" class="form-control" required="true" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"><small class="help-block form-text"></small></div>
															...
															<div class="row form-group">
                                                                <div class="col col-md-3"><label for="Username-input" class=" form-control-label">Student Name</label></div>
                                                                <div class="col-12 col-md-9"><input type="Userame" id="Username" name="Username" placeholder="Username" class="form-control" required="true"><small class="help-block form-text"></small></div>
                                                            </div>
                                                            
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="StudentId-input" class=" form-control-label">Student ID</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="StudentId" name="StudentId" placeholder="Admission Number" class="form-control" required="true" maxlength="15 "><small class="help-block form-text"></small></div>
                                                            </div>

                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="classId-input" class=" form-control-label">Class ID</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="classId" name="classId" placeholder="Class Number" class="form-control" required="true" maxlength="15 "><small class="help-block form-text"></small></div>
                                                            </div>
...
function myFunction2() {
  var txt;
  if (confirm("Are you sure you want to add the above student?")) {
    txt = "You pressed OK!";
  } else {
