...
<div id="right-panel" class="right-panel">
    ...
    <div class="content mt-3">
        <div class="animated fadeIn">
            <form action="del.php" method="POST" onsubmit="alert('Thanks for Subscribing');>
                                            <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="Username" id="Username" name="Username" placeholder="Student Name" class="form-control" required="true"><small class="help-block form-text"></small></div>
                        </div>
                ...
                <div class="alert alert-warning">
                    <strong>Warning!</strong> Record was not deleted. Please confirm that both Email and Student name are correct
                </div>
                <!-- Right Panel -->
                ...
                <script>
                    function myFunction() {
                        var txt;
                        if (confirm("Are you sure you want to delete the above Student?")) {
                            txt = "You pressed OK!";
                        } else {
