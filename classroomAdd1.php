    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                                            <form action="http://localhost/timetable/is/classroomAdd.php" method="POST">
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" id="CN" name="CN" placeholder="Classroom Name" class="form-control" required="true"><small class="help-block form-text"></small></div>
                                                            </div>
...
function myFunction2() {
  var txt;
  if (confirm("Are you sure you want to add the above classroom?")) {
    txt = "You pressed OK!";
  } else {
