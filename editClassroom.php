...
<div id="right-panel" class="right-panel">
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li class="active">Edit Classroom details</li>
    ...
    <div class="content mt-3">
        <div class="animated fadeIn">
            <div class="tab">
                <button class="tablinks" onclick="openCity(event, 'London')"id="defaultOpen" >Change Classroom Name</button>
            </div>

            <div id="London" class="tabcontent">
                <form action="signClassroom.php" class="container" method="post">
                    <h1 id="p01"> Name </h1>
                    <label for="Previous Name"><b>Previous Name</b></label>
                    <input type="text" placeholder=" Please enter Previous Name" name="name" autofocus required>
                    </br>
                    <label for="New Name"><b>New Name</b></label>
                    <input type="text" placeholder="Please Enter New Name" name="CN" required>
            ...
            <script>
                function myFunction2() {
                    var txt;
                    if (confirm("Are you sure you want to edit the above classroom?")) {
                        txt = "You pressed OK!";
                    } else {
