    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                                            <form action="http://localhost/timetable/is/teacherAdd.php" method="POST">
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
															...
															<div class="row form-group">
                                                                <div class="col col-md-3"><label for="Username-input" class=" form-control-label">Teacher Name</label></div>
                                                                <div class="col-12 col-md-9"><input type="Username" id="Username" name="Username" placeholder="Username" class="form-control" required="true"><small class="help-block form-text"></small></div>
                                                            </div>
                                                            
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="facultyNumber-input" class=" form-control-label">Faculty Number</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="facultyNumber" name="facultyNumber" placeholder="Faculty Number" class="form-control" required="true" maxlength="15 "><small class="help-block form-text"></small></div>
                                                            </div>

                                                             <div class="row form-group">
                                                                <div class="col col-md-3"><label for="alias-input" class=" form-control-label">Alias</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="alias" name="alias" placeholder="Alias" class="form-control" required="true" maxlength="15 "><small class="help-block form-text"></small></div>
                                                            </div>
...
function myFunction() {
 ...
 <script>
                    function myFunction2() {
                        var txt;
                        if (confirm("Are you sure you want to add the above Teacher?")) {
                            txt = "You pressed OK!";
                        } else {
