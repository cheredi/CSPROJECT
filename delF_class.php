                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Delete Assigned Classroom</li>
...
<form action="deleteClass.php" method="POST" onsubmit="alert('Thanks for Subscribing');>
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="CN-input" class=" form-control-label">Class Name</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="CN" name="CN" placeholder="Enter Class " class="form-control" required="true"><small class="help-block form-text"></small></div>
                                                            </div>
     ...
     <strong>Warning!</strong> Record was not deleted. Please confirm the  Subject Code
  </div>
                                <!-- Right Panel -->
