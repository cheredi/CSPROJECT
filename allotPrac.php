                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="deleteClass.php">Delete Assigned  classes</a></li>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Allot Practical</li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                                            <form action="http://localhost/timetable/is/allotpracValidation.php" method="POST">
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <strong>Assign Practical Subject </strong>
                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                <select name="tobealloted" class="list-group-item">
                                                                    ...
                                                                    $q = mysqli_query(mysqli_connect("localhost", "root", "", "timetable"),
                                                                        "SELECT * FROM subjects WHERE course_type = 'LAB' AND deleted=0");
                                                            ...
                                                            <div class="form-group">
                                                                <select name="toalloted" class="list-group-item">
                                                                    ...
                                                                    if ($row_count) {
                                                                        ...
                                                                        while ($row = mysqli_fetch_assoc($q)) {
                                                                            $mystring .= '<option value="' . $row['faculty_number'] . '">' . $row['username'] . '</option>';
                                                                        }
...
function myFunction() {
 ...
 <script>
                    function myFunction2() {
                        var txt;
                        if (confirm("Are you sure you want to add the above Allotment?")) {
                            txt = "You pressed OK!";
                        } else {
