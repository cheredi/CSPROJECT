            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li class="active">View Assigned Classrooms</li>
...
$courses = array('Computer Science 2nd Year Semester III', 'Computer Science 2nd Year Semester V');
while ($row = mysqli_fetch_assoc($q)) {
    if ($row['status'] == 0)
        continue;

    echo "<tr><td>{$row['name']}</td>
                    <td>{$courses[$row['status']-2]}
                    </td>
                    </tr>\n";
}
                    ?>