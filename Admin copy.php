    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Admin.php"><img src="images/admin.jpg" alt="Logo"></a>
                <a class="navbar-brand hidden" href="Admin.php"><img src="images/icons8_treatment_96_A0_Rectangle_17_pattern.png" alt="Logo"></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="subjectAdd.html">Add subject</a></li>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="classroomAdd.html">Add Classroom</a></li>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="deleteTheory.html">Delete Theory course</a></li>
                            ...
                            <li><i class="fa fa-table"></i><a href="deletePrac.html">Delete Practical course</a></li>
                            ...
                            <li><i class="fa fa-table"></i><a href="deleteClass.html">Delete Assigned  classes</a></li>
