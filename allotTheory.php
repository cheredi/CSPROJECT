    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Allot Theory</li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                                            <form action="http://localhost/timetable/is/allottValidation.php" method="POST">
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <strong>Assign Theory Subject </strong>
                                                    </div>
...
function myFunction() {
 ...
 <script>
                    function myFunction2() {
                        var txt;
                        if (confirm("Are you sure you want to allot the above Subject?")) {
                            txt = "You pressed OK!";
                        } else {
